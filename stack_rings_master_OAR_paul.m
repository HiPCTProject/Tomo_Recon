...
function stack_rings_master_OAR_paul(test_slice,varargin)

%% THE PARAMETERS

median_size                = 400 ; % maximum size of the rings that will be corrected
number_of_pass             = 3 ; % set to the desired number of pass of the whole filter
structure_removal_level    = 0.03 ; % threshold value to remove the samples structures before the final rings calculation, best 0.1, set to 0 to desactivate
blur_angle                 = 60 ; % minimum angular length of the rings
fusion_angle               = 60 ;% angular value for the fusion of the two picture parts in case of 180 degrees correction
