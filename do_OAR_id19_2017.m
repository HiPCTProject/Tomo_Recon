function [diary_file]=do_OAR_id19_2017(executable,first,last,njobs,workingdirectory,submitnowflag,gpu_cpu,walltime,otherparameters)
...
% Update: 
% VF: add diary on/off to write display in a file (diary_file) making it
% possible to read OAR job ID numbers
...
%
app.name=executable;
app.singleton='/data/id19/inhouse/OAR_UTILITIES/matlab_OAR_launcher_2017a.sh';
...
diary_file  = [subdir '/OAR_LOG_' fname '.' fndate random_num '.m']
diary(diary_file)
diary on
